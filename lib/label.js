...
var brother_label = function(urlQrcode, sku) {
    ...
    // xml += '<image:image>';
    // xml += '  <pt:objectStyle x="10.3pt" y="8.4pt" width="88pt" height="20.6pt" backColor="#FFFFFF" backPrintColorNumber="0" ropMode="COPYPEN" angle="0" anchor="TOPLEFT" flip="NONE">';
    ...
    // xml += '    <image:orgPos x="10.3pt" y="8.4pt" width="88pt" height="20.6pt"/>';
    ...
    xml += '  <text:stringItem charLen="' + sku.length + '">';
    xml += '    <text:ptFontInfo>';
    xml += '      <text:logFont name="Arial" width="0" italic="false" weight="700" charSet="0" pitchAndFamily="34"/>';
    xml += '      <text:fontExt effect="NOEFFECT" underline="0" strikeout="0" size="9pt" orgSize="28.8pt" textColor="#000000" textPrintColorNumber="1"/>';
    xml += '    </text:ptFontInfo>';
