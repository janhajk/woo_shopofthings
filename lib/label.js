...
var brother_XmlAdressLabel = function(lines) {
    ...
    // XML Head    
    xml += brother_head(paper, margin, 'landscape');
...
var brother_head = function(paper, margin, orientation) {
    const schemaUrl = 'http://schemas.brother.info/ptouch/2007/lbx/';
    var xml = '';
