...
var brother_label = function(urlQrcode, sku) {
    ...
    var paperPrintable = { height: paper.height - margin.top - margin.bottom, width: paper.width - margin.left - margin.right };
    ...
    // SKU
    xml += brother_text(sku, { x: paper.width - margin.right - 20, y: margin.top, w: 20, h: paperPrintable.height - 20, fontSize: 9, angle: 270, valign: 'BOTTOM' });
    // Closeup
